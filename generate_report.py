...
# Read raw data
df = pd.read_csv('/home/user/Reports/Master Monthly Marketing Tracker 2025 (Charles Luna Sheet).xlsx - Weekly (1_15-1_21).csv')
...
# Write to CSV
output_file = '/home/user/Reports/Weekly (01_15-01_21) - Organized.csv'
